...
- **Cách fix:** Thiết lập `max_iterations` trong `ResearchState`. Khi đạt đến giới hạn, hệ thống tự động ép buộc Writer tổng hợp câu trả lời từ dữ liệu hiện có hoặc trả về lỗi rõ ràng thay vì chạy tiếp.
